...
* in strings.xml app_name string to "Coinomi" and app_package to com.SHIELD.wallet
* in build.gradle the package from "com.SHIELD.wallet.dev" to "com.SHIELD.wallet"
* in AndroidManifest.xml the android:icon to "ic_launcher" and all "com.SHIELD.wallet.dev.*"  to "com.SHIELD.wallet.*"

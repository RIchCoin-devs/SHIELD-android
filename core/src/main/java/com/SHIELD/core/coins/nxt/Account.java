package com.SHIELD.core.coins.nxt;
...
//                + " existing key " + com.SHIELD.core.coins.nxt.Convert.toHexString(account.getPublicKey()) + " new key " + com.SHIELD.core.coins.nxt.Convert.toHexString(publicKey));
//    }
...
//        if (id != com.SHIELD.core.coins.nxt.Crypto.rsDecode(com.SHIELD.core.coins.nxt.Crypto.rsEncode(id))) {
...
//        name = com.SHIELD.core.coins.nxt.Convert.emptyToNull(name.trim());
//        description = com.SHIELD.core.coins.nxt.Convert.emptyToNull(description.trim());
...
//            data = com.SHIELD.core.coins.nxt.Convert.compress(data);
//        }
//        return EncryptedData.encrypt(data, com.SHIELD.core.coins.nxt.Crypto.getPrivateKey(senderSecretPhrase), getPublicKey());
//    }
//
...
//        }
//        byte[] decrypted = encryptedData.decrypt(com.SHIELD.core.coins.nxt.Crypto.getPrivateKey(recipientSecretPhrase), getPublicKey());
//        if (uncompress && decrypted.length > 0) {
//            decrypted = com.SHIELD.core.coins.nxt.Convert.uncompress(decrypted);
//        }
//        return decrypted;
//    }
//
